Manuelle JobEngine-Testdateien für AdeaAutomation / MailboxAutomation
...
Testbeispiel:
1. Den Inhalt des passenden Queue-Ordners in MailboxAutomation/queues/<queue>/incoming kopieren.
2. In MailboxAutomation wechseln.
...
Die produktive Standardkonfiguration MailboxAutomation/config/appsettings.json verwendet nun CsvDelimiter |, damit diese manuellen Queue-Dateien ohne Zusatzkonfiguration direkt importiert werden können.
