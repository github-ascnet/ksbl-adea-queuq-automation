...
function Invoke-AddDistributionListResponsibles {
    ...
    try {
        ...
        Write-LogInfo -Logger $Context.Logger -Message "Invoke-AddDistributionListResponsibles processed $($rows.Count) row(s)."
        New-JobSucceededResult -Message "Invoke-AddDistributionListResponsibles succeeded."
    }
    catch {
