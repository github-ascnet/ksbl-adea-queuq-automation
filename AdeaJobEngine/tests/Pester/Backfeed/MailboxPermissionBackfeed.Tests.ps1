Describe 'MailboxPermission Backfeed Read-Map' {
    ...
    It 'Service pipeline returns Succeeded with ReadCount and StagedCount' {
        ...
        Mock -ModuleName MailboxPermissionBackfeedService -CommandName Initialize-MailboxPermissionBackfeedStateInsertOnly {
            [pscustomobject]@{ Success = $true; BackfeedRunId = 'aaaaaaaa-1111-1111-1111-111111111111'; InsertedCount = 1; UpdatedCount = 0; DeletedCount = 0; ReactivatedCount = 0; UnchangedCount = 0; FailedCount = 0; Message = 'State initialized.'; ErrorCode = $null; Errors = @() }
        }
    ...
    It 'Service uses InsertedCount from state initialization and keeps Update Delete at zero' {
        Mock -ModuleName MailboxPermissionBackfeedService -CommandName Read-MailboxPermissionBackfeedSources {
        ...
        Mock -ModuleName MailboxPermissionBackfeedService -CommandName Initialize-MailboxPermissionBackfeedStateInsertOnly {
            [pscustomobject]@{ Success = $true; BackfeedRunId = '55555555-aaaa-bbbb-cccc-555555555555'; InsertedCount = 6; UpdatedCount = 0; DeletedCount = 0; ReactivatedCount = 0; UnchangedCount = 4; FailedCount = 0; Message = 'State initialized.'; ErrorCode = $null; Errors = @() }
        }
        ...
        $result.InsertedCount | Should -Be 6
